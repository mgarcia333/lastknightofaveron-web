# The Last Knight of Averon — Web

Portal web para jugar a **[The Last Knight of Averon](https://github.com/mgarcia333/lastknightofaveron)**
(action-RPG 2D de fantasía oscura hecho en Unity) directamente en el navegador, sin
instalar nada.

🎮 **Producción:** https://lastknightofaveron-web.mgarciap.workers.dev/
...
- Tipografías originales del juego, `Old London` (gótica, títulos) y `Optimus Princeps`
  (cuerpo de texto) — `public/fonts/`.
- Paleta negro/carmesí con acentos dorados, inspirada en la luna de sangre del juego.
- Arte del propio juego (titlecard, key art) como elementos visuales del hero (`public/images/`).
...
2. Copia el contenido de la carpeta `Build/` generada a `public/game/Build/` en este
   repositorio (deben quedar `LastKnightOfAveron.loader.js`, `LastKnightOfAveron.data`,
   `LastKnightOfAveron.framework.js`, `LastKnightOfAveron.wasm`).
...
👉 https://github.com/mgarcia333/lastknightofaveron
